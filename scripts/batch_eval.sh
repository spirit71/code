...
EXP_NAME="baseline_03_lora01"

# 2. 指定模型文件夹路径 (在此处修改为你实际的模型路径)
TARGET_MODEL_DIR="./logs/default/2025-12-17_03-28-23"
...
# # 4. pitts30k
run_dataset_eval "pitts30k" \
"--eval_datasets_folder=/root/data/Pittsburgh250k --eval_dataset_name=pitts30k"

# 5. nordLand
run_dataset_eval "nordland" \
"--eval_datasets_folder=/home/code_qy_7_28/VPR-datasets-downloader/nordland_data --eval_dataset_name=images_winter_as_quries"
