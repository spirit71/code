...
##pitts30k
python3 eval.py --eval_datasets_folder=/root/data/Pittsburgh --eval_dataset_name=pitts30k  --resume=./logs/default/2025-09-28_04-33-24/model_epoch_15.pth

##nordland
python3 eval.py --eval_datasets_folder=/home/code_qy_7_28/VPR-datasets-downloader/datasets/Nordland  --eval_dataset_name=images_winter_as_quries --resume=./logs/default/2025-09-28_04-33-24/model_epoch_15.pth
