...
# 基础配置
BASE_CMD="python3 eval.py --eval_datasets_folder=/root/data/Pittsburgh --eval_dataset_name=pitts30k  "
#diniv2_L
MODEL_DIR="./logs/default/2025-12-01_02-38-54"
RESULTS_DIR="./eval_results/pitts30k_results_seed42"
