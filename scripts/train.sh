## pitts30k
# python3 train.py --eval_datasets_folder=/root/data/Pittsburgh250k --eval_dataset_name=pitts30k --foundation_model_path=./dinov2_vitb14_pretrain.pth --epochs_num=100  --patience=100
# python3 train.py --eval_datasets_folder=/root/data/Pittsburgh250k --eval_dataset_name=pitts30k --foundation_model_path=./dinov2_vitl14_reg4_pretrain.pth --epochs_num=200  --patience=100  --resume /home/code_qy_7_28/EDTformer/logs/default/2025-10-15_13-47-05/last_model.pth
python3 train.py --eval_datasets_folder=/root/data/Pittsburgh --eval_dataset_name=pitts30k --foundation_model_path=./dinov2_vitb14_pretrain.pth --epochs_num=100  --patience=25  
