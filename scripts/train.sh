## pitts30k
python3 train.py --eval_datasets_folder=/root/data/Pittsburgh --eval_dataset_name=pitts30k --foundation_model_path=./weights/dinov2_vitb14_pretrain.pth --epochs_num=100  --patience=100
# python3 train.py --eval_datasets_folder=/home/code_qy_7_28/VPR-datasets-downloader/datasets  --eval_dataset_name=sped/images --foundation_model_path=./weights/dinov2_vitb14_pretrain.pth --epochs_num=100  --patience=100 
...
#调试
# --eval_datasets_folder=/root/data/Pittsburgh --eval_dataset_name=pitts30k --foundation_model_path=./weights/dinov2_vitb14_pretrain.pth --train_batch_size=2 